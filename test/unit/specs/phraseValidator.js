...
describe('in phraseValidator', function() {
    ...
    describe('when validating a phrase', function() {
        ...
        it('codebase64 has to be valid', function() {
            expect(function() {
                phraseValidator.validate('domain', {
                    url: 'url',
                    get: {
            ...
            }).to.throw('invalid:phrase:get:codebase64');
        });

        it('codebase64 validates well', function() {
            ...
            phraseValidator.validate('domain', {
                ...
                get: {
                    doc : 'eyy',
                    codebase64 : "cmVzLnJlbmRlcignaW5kZXgnLCB7dGl0bGU6ICdoZWxsbyB3b3JsZCd9KTs="
                }
            });
